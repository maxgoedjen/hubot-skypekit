...
class ContactGroup(skypekit.Object):
    ...
    Note that this excludes Skype contacts that have either never been the target of Contact::SetBuddyStatus(true) or were last the target of Contactact::SetBuddyStatus(false). 
     ...
     - XMPP_CONTACTS - contacts from XMPP server
     - PASSPORT_CONTACTS - LiveID contacts from EAS
     - LYNC_CONTACTS - Lync contacts from EAS
    """
...
class Contact(skypekit.Object):
    ...
    def _sk_get_profile_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\023]\002", 19, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_avatar_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\266\001]\002", 182, False)) & 0xFFFFFFFFL
    ...
    def _sk_get_mood_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\267\001]\002", 183, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_authreq_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\031]\002", 25, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_lastonline_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG#]\002", 35, False)) & 0xFFFFFFFFL
    ...
    def _sk_get_lastused_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG']\002", 39, True)) & 0xFFFFFFFFL
    ...
    def SetPhoneNumber(
        ...
        B{Arguments:}
         - B{num} - The property pair being set, which must be in the range 1..3 Note that there are only three target slots here, for four ("0".."3") label values. 
...
class ContactSearch(skypekit.Object):
    """
    This class encapsulates functionality for looking up contacts on the Skype network. Contacts can be searched by portion of their name, e-mail address, language preferences, etc. <b>NB!</b> There is currently a known problem with complex contact searches, with only the last of the added search term being actually searched for. While we are investigating ways to fix this, contacts can be searched for by only one property at a time. 
    
    <b>NB!</b> There exists a known problem with ContactSearch causing a noticeable memory leak. Under normal circumstances, this should not be a problem but massive amounts of contact searches are not infinitely sustainable without restarting the client. 
...
class Participant(skypekit.Object):
    ...
    def _sk_get_convo_id(self):
        ...
        """
        return module_id2classes[18](self._sk_property("ZG\242\007]\023",  930, True), self.transport)
    ...
    def _sk_get_live_start_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\253\007]\023", 939, True)) & 0xFFFFFFFFL
    ...
    def Ring(
        ...
        B{Arguments:}
         ...
         - B{nonse_word} - Nonse word used to provide end-point verification (ignore if you don't know what it means)
        """
        ...
        l_request.add_parm('S', 7, nonse_word)
        self.transport.xcall(l_request)
    def RingIt(self):
        """
    ...
    def GetVideo(self):
        """
        This method is now deprecated. It has been replaced by Participant::GetLiveSessionVideos, Participant::CreateLocalVideo and Participant::CreatePreviewVideo methods. 
    ...
    def Retire(self):
        """
        Forcibly removes this participant from conversation. This method is for removing other people from conversations (for example: as administrative punishment for flooding conversation with spam messages). For local user to leave a conversation, use Conversation::RetireFrom instead. Note that this method is not intended for dropping out of live sessions. It removes the participant from the conversation entirely. For dropping the local user out of live session (hang up), use Conversation::LeaveLiveSession or Participant::Hangup instead. 
        
        """
        l_request = skypekit.XCallRequest("ZR\023\006", 19, 6)
        l_request.add_parm('O', 0, self)
        self.transport.xcall(l_request)
    def GetLiveSessionVideos(self):
        """
        Returns a list of incoming video streams from the Participant. As SkypeKit currently supports only one video stream per Participant, this list can currently contain either 1 or 0 elements. Note that this method should be used for retrieving video objects for remote Participants (incoming video streams). To retrieve local video object, use Skype::CreateLocalVideo or Skype::CreatePreviewVideo methods instead. 
        
        Note that for GetLiveSessionVideos to be successful, the video has to be available for that Participant. This can be checked for by examining Participant VIDEO_STATUS property, once it becomes VIDEO_AVAILABLE you can use this method to obtain the Video object. 
        
        For more information see details section of the Video class. 
        
        This method replaces the now deprecated Participant::GetVideo. 
        
        
        B{Return values:}
         - B{videos}
        """
        l_request = skypekit.XCallRequest("ZR\023\221\001", 19, 145)
        l_request.add_parm('O', 0, self)
        l_response = self.transport.xcall(l_request)
        l_result = [module_id2classes[11](oid, self.transport) for oid in l_response.get(1, [])]
        return l_result
    def OnIncomingDTMF(
        self,
        dtmf
    ...
    def OnLiveSessionVideosChanged(self):
        """
        This event fires when the number of available video streams for the Participant object changes. As SkypeKit currently supports only one video stream per Participant, the change will be eithe from 0 to 1 or from 1 to 0. The number of video objects can be determined by retrieving the video list with Participant::GetLiveSessionVideos and checking how many elements it contains. 
        
        """
        pass
    def _sk_on_live_session_videos_changed(self, parms):
        """ internal event dispatcher for OnLiveSessionVideosChanged  """
        self.OnLiveSessionVideosChanged()
    event_handlers[146] = "_sk_on_live_session_videos_changed"
...
class Conversation(skypekit.Object):
    ...
    def _sk_get_live_start_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\316\007]\022", 974, True)) & 0xFFFFFFFFL
    live_start_timestamp = property(_sk_get_live_start_timestamp)
    ...
    def _sk_get_inbox_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\240\007]\022", 928, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_inbox_message_id(self):
        ...
        """
        return module_id2classes[9](self._sk_property("ZG\315\007]\022",  973, True), self.transport)
    ...
    def _sk_get_active_vm_id(self):
        ...
        """
        return module_id2classes[7](self._sk_property("ZG\313\007]\022",  971, True), self.transport)
    ...
    def _sk_get_consumption_horizon(self):
        ...
        """
        return long(self._sk_property("ZG\323\007]\022", 979, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_last_activity_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\325\007]\022", 981, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_spawned_from_convo_id(self):
        ...
        """
        return module_id2classes[18](self._sk_property("ZG\223\007]\022",  915, True), self.transport)
    ...
    def _sk_get_creation_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\210\007]\022", 904, True)) & 0xFFFFFFFFL
    ...
    def TransferLiveSession(
        ...
        B{Arguments:}
         ...
         - B{context} - Leave empty if you don't know what to use it for
        """
        l_request = skypekit.XCallRequest("ZR\022(", 18, 40)
        l_request.add_parm('O', 0, self)
        l_request.add_parm('S', 1, identities)
        l_request.add_parm('S', 2, transfer_topic)
        l_request.add_parm('B', 3, context)
        self.transport.xcall(l_request)
    ...
    def PostFiles(
        ...
        B{Return values:}
         ...
         - B{message} - resulting message if no error
        """
        ...
        l_result += (l_response.get(2, '')),
        l_result += (module_id2classes[9](l_response.get(3), self.transport)),
        return l_result
    ...
    def RetireFrom(self):
        """
        Leaves the conference. Not applicable to dialogs. Note that this method is not intended for dropping out of live sessions. It removes the participant from the conversation entirely. For dropping out of live session (hang up), use Conversation::LeaveLiveSession or or Participant::Hangup instead. 
    ...
    def FindMessage(
        ...
        B{Arguments:}
         ...
         - B{from_timestamp_up} - Search starting point. Search will proceed from this point, backwards in time (earlier messages). Defaults to MAX_UINT. 
        ...
        l_result = module_id2classes[9](l_response.get(1), self.transport)
        return l_result
    def AttachVideoToLiveSession(
        self,
        send_video
        ):
        """
        The intended use of this is to attach outgoing (local) video object to a live conversation. Once you have obtained the local video object with Skype::CreateLocalVideo, you cannot start sending the video unless it is known, who are the intended recepients. This is determined by the participant list of the currently live conversation. For this to work, the video object and the conversation need to know about eachother, which is exactly what this method accomplishes. Once attached, the Video and Conversation objects stay linked until the conversation goes off live state. There is no Detatch method for disassociation. If you wish to remove your outgoing video, you can call the Video::Stop method. 
        
        
        B{Arguments:}
         - B{send_video} - the video object retrieved with Skype::CreateLocalVideo 
        
        """
        l_request = skypekit.XCallRequest("ZR\022\223\001", 18, 147)
        l_request.add_parm('O', 0, self)
        l_request.add_parm('O', 1, send_video)
        self.transport.xcall(l_request)
    ...
    def OnMessage(
        ...
        """
        This events fires when a new message appears in the conversation. This can be both a new incoming message, or a message created by Conversation::PostXXX method by the local user. Note that there are two separate events that fire for each message - one in here, in the Conversation class and another one in Skype class. For all intents and purposes, these events are interchangeable and both (or just any one of them) can be used for handling new messages. However, to avoid confusion down the line, it is recommended that you pick one of them and then consistently use only that event throughout your entire project. 
    ...
    def OnSpawnConference(
        ...
        """
        Conversations normally start their existance as dialogs, between two participants - the local user and one of the contacts. An exception to this are conversations created with Skype::CreateConference method. But usually, bigger conversations start out as dialogs between two people. In fact, there is always one and exactly one dialog conversation per contact. You cannot have two different dialogs with the same contact. When a third contact gets added to a dialog, the original dialog conversation has to be preserved. Because of this, the two particpants into three or more participants transition is somewhat special. Instead of simply adding the third participant, what happens instead is that a new conversation gets created and all the (at that pont three) participants get automatically added to it. After that, the fourth and further participants will be added to the same conversation object. 
        
        From the GUI perspective, what happens is that the active conversation gets changed. The active conversation object and all the (two) associated participant objects become invalid. The GUI side of the conversation thus needs to do a complete reload, switching the active conversation and updating to new participant list, based on the newly created SkypeKit side objects. 
        
        In case the conversation was in a live state at the time, the entire sequence will be like this: 
          - a new conversation is created, both people from old 1-on-1 conversation and the new ones get added in; 
          - the new conversation goes live; 
          - the old 1-on-1 conversation goes OFF live; 
          - in the old 1-on-1, a message gets posted with type SPAWNED_CONFERENCE and this event will fire with new conversation in the spawned field. 
...
class Message(skypekit.Object):
    ...
    """
    PERMISSIONS = {0:'PERM_NONE', 'PERM_NONE':0, 1:'PERM_EDITABLE', 'PERM_EDITABLE':1, 2:'PERM_DELETABLE', 'PERM_DELETABLE':2}
    """
    bitfield used to express what can be done with a message
     - PERM_NONE
     - PERM_EDITABLE - message can be edited with new content
     - PERM_DELETABLE - message can be deleted whole (edited to blank)
    """
    ...
    def _sk_get_convo_id(self):
        ...
        """
        return module_id2classes[18](self._sk_property("ZG\300\007]\011",  960, True), self.transport)
    convo_id = property(_sk_get_convo_id)
    ...
    def _sk_get_timestamp(self):
        ...
        """
        return long(self._sk_property("ZGy]\011", 121, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_edit_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\337\001]\011", 223, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_identities(self):
        ...
        Message type-specific parameter. Depending of Message type, this property contains: 
          - STARTED_LIVESESSION - list of participants in the call; 
    ...
    def _sk_get_leavereason(self):
        ...
        Use for STARTED/ENDED_LIVESESSION is to provide simpler, enum based 
        handling and deprecates the reason property (only set for dialogs)
        """
    ...
    def GetPermissions(self):
        ...
        B{Return values:}
         - B{result}
        """
        l_request = skypekit.XCallRequest("ZR\011:", 9, 58)
        l_request.add_parm('O', 0, self)
        l_response = self.transport.xcall(l_request)
        l_result = skypekit.enumof(Message.PERMISSIONS, l_response.get(1))
        return l_result
    def Edit(
        self,
        new_text,
        ...
        B{Arguments:}
         ...
         - B{legacy_prefix} - If the edit is received by a client not supporting displaying edits, 
        it will be shown as a new message, prefixed by this parameter. 
        Default value is a prefix in English.
        """
        ...
        l_request.add_parm('S', 4, legacy_prefix)
        self.transport.xcall(l_request)
    def GetContacts(self):
        """
...
class Video(skypekit.Object):
    ...
    Let there be 3-way live conversation C and participants P1, P2 and P3. P1 is the local user. Remote participants P2 is capable of sending video. Remote user P3 is not capable of sending video. You would then end up with 3 video objects: V1, V2 and V0. 
    
      - C->P1->V1-> outgoing video stream 
      - C->P2->V2-> incoming video stream 1 
      - C->P3-> no video object as participant P4 does not advertise supporting video 
      - V0-> local webcam preview - this is not attached to any particular conversation, however the corresponding video object can be retrieved with Skype::CreatePreviewVideo method. 
    
    Note that using V0 in a live conversation is not recommended. The video object you get back from Skype::CreatePreviewVideo is intended for webcam test and configuration part of your GUI. This video object is independant of any conversation. 
    ...
    If you get to VIDEO_AVAILABLE (not necessarily for all Participants), you can retrieve Video object for that Participant. Note that doing this is different, depending on whether the Participant is local user (outgoing video) or remote user (incoming video). 
    
    In case of local user: 
      - use Skype::CreateLocalVideo to retrieve the video object; 
      - use Conversation::AttachVideoToLiveSession to associate the video object with your live Conversation. 
    
    In case of remote user: 
      - use Participant::GetLiveSessionVideos to retrieve a list of video objects. As SkypeKit only supports one video stream per Participant, this list will contain either 1 or 0 elements. The video object you are looking for, either is or isn't the only element in that list. 
    
    At this point, you should check whether the Video::STATUS property is already AVAILABLE. If it is, you can start the video (send or receive) immediately. However, if it's not available yet - it doesn't mean it will not become available later. 
    
    To check for that you will need to handle Video::STATUS property changes to check for Video::STATUS becoming AVAILABLE. Once that happens, you can call Video::Start method to start sending or receiving video. 
    
    In case of successful video call, the sequence of Video::STATUS and Participant::VIDEO_STATUS changes for each Participant and Video object should look like this: 
    ...
    Also note that the Video object does not deal with video rendering. The Video object is just a control interface. To display incoming (or local preview) video, there exists a separate (shared memory based) interface, through which the SkypeKit runtime sends decoded video frames to the client UI. The server side of this interface exists in all desktop SkypeKit runtimes. The client side of the interface is currently implemented in C++ embedded and .NET wrappers. There is no client side interface for video rendering in Python or Java wrappers. 
    
    However, you can take either the C++ based qt_videocalls example or the .NET SktVideoRenderer class sources and try your hand and porting the interface to your favourite combination of language and GUI framework. 
    ...
    def _sk_get_convo_id(self):
        ...
        """
        return module_id2classes[18](self._sk_property("ZG\320\010]\013",  1104, True), self.transport)
    convo_id = property(_sk_get_convo_id)
    ...
    def SelectVideoSource(
        ...
        B{Arguments:}
         - B{media_type} - Screensharing or webcam. 
        
         - B{webcam_name} - Displayname of the webcam. 
        
         - B{device_path} - Device ID (from the 2nd list you get back from the Skype::GetAvailableVideoDevices method) 
        
         - B{update_setup} - Set true if you want to change the default value. 
...
class Voicemail(skypekit.Object):
    ...
    def _sk_get_timestamp(self):
        ...
        """
        return long(self._sk_property("ZGj]\007", 106, True)) & 0xFFFFFFFFL
    timestamp = property(_sk_get_timestamp)
    ...
    def _sk_get_convo_id(self):
        ...
        """
        return module_id2classes[18](self._sk_property("ZG\276\006]\007",  830, True), self.transport)
    convo_id = property(_sk_get_convo_id)
...
class Sms(skypekit.Object):
    ...
    """
    OUTGOING_REPLY_TYPE = {1:'REPLY_SKYPENAME', 'REPLY_SKYPENAME':1, 2:'REPLY_USER_PHONE_NR', 'REPLY_USER_PHONE_NR':2, 3:'REPLY_2WAY_AUTOASSIGNED_NR', 'REPLY_2WAY_AUTOASSIGNED_NR':3, 4:'REPLY_TYPE_MIXED', 'REPLY_TYPE_MIXED':4}
    """
     - REPLY_SKYPENAME - outgoing Sms source ID is set to skypename (where applicable)
     - REPLY_USER_PHONE_NR - user's verified mobile nr is used as outgoing Sms source ID
     - REPLY_2WAY_AUTOASSIGNED_NR - outgoing Sms source ID was allocated from 2-way number pool
     - REPLY_TYPE_MIXED - outgoing Sms targets have different types, use GetTargetReplyType to see the real type
    """
    ...
    """
     - COMPOSING - SMS can be edited and targets changed
     - SENDING_TO_SERVER - SMS is being sent currently to server
     - SENT_TO_SERVER - SMS has been sent to server, pending delivery notification
     - DELIVERED - SMS has been successfully delivered to all recipients
     - SOME_TARGETS_FAILED - SMS has been delivered to some recipients, but some failed
     - FAILED - SMS has not been delivered to any recipient
    """
    FAILUREREASON = {
        1:'MISC_ERROR',
    ...
    """
    REPLY_CAPABILITY = {0:'NOT_CAPABLE', 'NOT_CAPABLE':0, 1:'CAPABLE_GLOBALLY', 'CAPABLE_GLOBALLY':1, 2:'CAPABLE_LOCALLY', 'CAPABLE_LOCALLY':2}
    """
    2-way Sms reply capabilities returned by CanTargetReply
     - NOT_CAPABLE - not 2-way capable
     - CAPABLE_GLOBALLY - 2-way capable globally (sms will be sent from another country)
     - CAPABLE_LOCALLY - 2-way capable in destination country (sms will be sent from destination country)
    """
    ...
    P_TYPE = 190
    def _sk_get_outgoing_reply_type(self):
        return skypekit.enumof(Sms.OUTGOING_REPLY_TYPE, self._sk_property("ZG\273\011]\014", 1211, True))
    outgoing_reply_type = property(_sk_get_outgoing_reply_type)
    propid2label[1211] = "outgoing_reply_type"
    ...
    def _sk_get_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\306\001]\014", 198, True)) & 0xFFFFFFFFL
    timestamp = property(_sk_get_timestamp)
    ...
    def _sk_get_chatmsg_id(self):
        ...
        """
        return module_id2classes[9](self._sk_property("ZG\310\006]\014",  840, True), self.transport)
    ...
    def GetTargetStatus(
        ...
        return l_result
    def GetTargetReplyNumber(
        self,
        target
        ):
        """
        Call this when target has been delivered, to see what is the assigned number. 
        Calling before target has been delivered shows preliminary assigned number, which may not be allocated (ie when delivery fails)
        ...
        B{Return values:}
         - B{number}
        """
        l_request = skypekit.XCallRequest("ZR\014\003", 12, 3)
        l_request.add_parm('O', 0, self)
        l_request.add_parm('S', 1, target)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, '')
        return l_result
    def GetTargetReplyType(
        self,
        target
        ):
        """
        ...
        B{Return values:}
         - B{type_}
        """
        l_request = skypekit.XCallRequest("ZR\014\012", 12, 10)
        l_request.add_parm('O', 0, self)
        l_request.add_parm('S', 1, target)
        l_response = self.transport.xcall(l_request)
        l_result = skypekit.enumof(Sms.OUTGOING_REPLY_TYPE, l_response.get(1))
        return l_result
    def GetTargetPrice(
        self,
        target
...
class Transfer(skypekit.Object):
    ...
    def _sk_get_starttime(self):
        ...
        """
        return long(self._sk_property("ZGU]\006", 85, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_finishtime(self):
        ...
        """
        return long(self._sk_property("ZGV]\006", 86, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_convo_id(self):
        ...
        """
        return module_id2classes[18](self._sk_property("ZGb]\006",  98, True), self.transport)
    convo_id = property(_sk_get_convo_id)
...
class Account(skypekit.Object):
    ...
    When creating a new account, setting the Account properties (the list above) needs to be done after the Account::Register has successfully finished. Attempts to set the properties before that will cause the setter methods to fail. There is one exception: The P_FULL_NAME property. That one needs to be set before calling the Register method. 
    ...
    LOGOUTREASON = {
        ...
        25:'ATO_BLOCKED',
        26:'REMOTE_LOGOUT',
        27:'ACCESS_TOKEN_RENEWAL_FAILED',
        'LOGOUT_CALLED'                                     : 1,
    ...
    Recognized values for the Account::P_LOGOUTREASON. Note that this property should only be examined when Account::P_STATUS is LOGGED_OUT or LOGGED_OUT_AND_PWD_SAVED. That is, you should not monitor changes to this property in Account::OnChange callback, other than after already having checked that P_STATUS property has appropriate value. The reason for this is that the LOGOUTREASON does not get reset before the next login attempt. For example: if a user tried to log in with a wrong password, the LOGOUTREASON gets set to INCORRECT_PASSWORD. Now, if the user tries to log in again, and yet again submits an incorrect password, the value of the LOGOUTREASON does not change anymore, because it already is set to INCORRECT_PASSWORD. Consequently, Account::OnChange will not fire in this case. 
     ...
     - SERVER_OVERLOADED - sync errors at login/registration or RPS server errors
     ...
     - ATO_BLOCKED - ATO (Account TakeOver) detected, account blocked
     - REMOTE_LOGOUT - logout from another instance
     - ACCESS_TOKEN_RENEWAL_FAILED - Live ID access token renewal failure
    """
    ...
    def _sk_get_registration_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\241\006]\005", 801, True)) & 0xFFFFFFFFL
    ...
    def _sk_get_profile_timestamp(self):
        ...
        UNIX timestamp of last profile change
        """
        return long(self._sk_property("ZG\023]\005", 19, True)) & 0xFFFFFFFFL
    profile_timestamp = property(_sk_get_profile_timestamp)
    propid2label[19] = "profile_timestamp"
    P_PROFILE_TIMESTAMP = 19
    def _sk_get_mood_text(self):
    ...
    def _sk_get_avatar_timestamp(self):
        ...
        UNIX timestamp of when current avatar was set
        """
        return long(self._sk_property("ZG\266\001]\005", 182, True)) & 0xFFFFFFFFL
    avatar_timestamp = property(_sk_get_avatar_timestamp)
    propid2label[182] = "avatar_timestamp"
    P_AVATAR_TIMESTAMP = 182
    def _sk_get_mood_timestamp(self):
        ...
        """
        return long(self._sk_property("ZG\267\001]\005", 183, True)) & 0xFFFFFFFFL
    mood_timestamp = property(_sk_get_mood_timestamp)
    propid2label[183] = "mood_timestamp"
    P_MOOD_TIMESTAMP = 183
    def _sk_get_rich_mood_text(self):
    ...
    def LoginWithOAuth(
        ...
        """
        Login to an account with an oAuth token - the skypename will not be known yet. 
        The account should be initialized with GetAccount(NULL, account) or GetAccount("", account)
        ...
        B{Arguments:}
         ...
         - B{save_data_locally}
        """
        l_request = skypekit.XCallRequest("ZR\005\035", 5, 29)
        l_request.add_parm('O', 0, self)
        l_request.add_parm('U', 1, partner_id)
        l_request.add_parm('S', 2, access_token)
        l_request.add_parm('S', 3, refresh_token)
        l_request.add_parm('b', 4, save_pwd)
        l_request.add_parm('b', 5, save_data_locally)
        self.transport.xcall(l_request)
    def Register(
        self,
        password,
        ...
        Note that after Account creation, you will almost certainly want to set some other Account class properties - see Account class detailed description for more on this. Setting the Account properties needs to be done after the Account::Register has successfully finished. Attempts to set the properties before that will cause the setter methods to fail. There is one exception: The P_FULL_NAME property. That one needs to be set before calling the Register method. 
    ...
    def GetCapabilityStatus(
        ...
        l_result += (long(l_response.get(2, 0L)) & 0xFFFFFFFFL),
        return l_result
...
class Skype(object):
    ...
    SETUPKEY_DB_PAGE_SIZE = "*Lib/DbManager/PageSize"
    ...
    def GetUnixTimestamp(self):
        ...
        If the local system time is incorrect my more than one year, the time provided 
        by the Skype network will be provided, which is correct. Therefore this function 
        can be used to adjust the system time if set incorrectly (e.g. if set to 1.1.1970).
        ...
        l_response = self.transport.xcall(l_request)
        l_result = long(l_response.get(1, 0L)) & 0xFFFFFFFFL
        return l_result
    def Start(self):
        """
        No description available.
        ...
        B{Return values:}
         - B{started}
        """
        l_request = skypekit.XCallRequest("ZR\000\221\001", 0, 145)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, False)
        return l_result
    ...
    """
     ...
     - SKYPE
     - SKYPE_MYSELF
     - SKYPE_UNDISCLOSED - Not used
     - PSTN
     - PSTN_EMERGENCY
     - PSTN_FREE
     - PSTN_UNDISCLOSED
     - CONFERENCE - Multi-party conversation identity
     - EXTERNAL
     - XMPP - XMPP identities, used for Facebook
     - PASSPORT - Live ID identities
     - LYNC - Lync identities
    """
    def GetIdentityType(
        self,
        identity
    ...
    def GetConversationByIdentity(
        ...
        B{Arguments:}
         - B{convo_identity}
         - B{match_pstn} - The matchPSTN parameter changes the behaviour of the method for PSTN numbers. 
        When matchPSTN is true, the method will look if there is a skypename that has this PSTN number associated 
        (in his profile or as user-assigned phone number), and if there is, the method returns the conversation with that skypename. 
        ...
        l_request.add_parm('b', 2, match_pstn)
        l_response = self.transport.xcall(l_request)
        l_result = module_id2classes[18](l_response.get(1), self.transport)
        return l_result
    ...
    def GetMessageListByType(
        ...
        B{Arguments:}
         - B{type_} - Type of messages requested. For POSTED_TEXT or POSTED_EMOTE, returns a list with both types
    ...
    def OnMessage(
        ...
        """
        This events fires when a new message appears. This can be both a new incoming message, or a message created by Conversation::PostXXX method by the local user. Note that there are two separate events that fire for each message - one in Skype class and another one in Conversation class - Conversation::OnMessage. For all intents and purposes, these events are interchangeable and both (or just any one of them) can be used for handling new messages. However, to avoid confusion down the line, it is recommended that you pick one of them and then consistently use only that event throughout your entire project. 
        
        
        B{Return values:}
         - B{message} - link to the new Message object 
         ...
         - B{conversation} - link to the conversation object in which the new Message was created 
    ...
    def GetPreviewVideo(
        ...
        """
        This is now marked as deprecated and replaced by Skype::CreatePreviewVideo method. 
    ...
    def CreateLocalVideo(
        ...
        """
        Retrurns video object for the local webcam specified in deviceName and devicePath arguments. The intended use of this method is in live conversations, for retrieving local user's video object, after it is determined that video object for the participant object for local user has video available. The video object can then be used for dual purpose, for local video rendering and sending the video stream out to remote parties. 
        
        Note that in order to actually send the video out to remote participants, you will need to associate the Video object with your live conversation, by calling the Conversation::AttachVideoToLiveSession method. Otherwise, the video will be able to render in your local GUI but remote participants will not be able to receive it. 
        
        For list of valid webcams (for deviceName and devicePath arguments), use Skype.GetAvailableVideoDevices method. Note that Skype.GetAvailableVideoDevices should not be called immediately after successful login. It will take several seconds for the runtime to populate the webcam list and until that happens, the video device lists will return empty. Instead of retrieving the video device list at startup, you should always handle the Skype::OnAvailableVideoDeviceListChange event and use the GetAvailableVideoDevices method to check if the list has now non-zero video devices in it. You should only enable video features in your GUI once this has happened. 
        
        
        B{Arguments:}
         - B{type_} - either screen sharing or video stream from webcam 
        
         - B{device_name} - human readable device name (see Skype::GetAvailableVideoDevices method). 
        
         - B{device_path} - video device ID (path) (see Skype::GetAvailableVideoDevices method). 
        
        
        B{Return values:}
         - B{video} - returns the video object. 
        
        """
        l_request = skypekit.XCallRequest("ZR\000\217\001", 0, 143)
        l_request.add_parm('e', 1, Video.MEDIATYPE[type_])
        l_request.add_parm('S', 2, device_name)
        l_request.add_parm('S', 3, device_path)
        l_response = self.transport.xcall(l_request)
    ...
    def CreatePreviewVideo(
        ...
        """
        Retrurns video object for the local webcam specified in deviceName and devicePath arguments. This method should not be used for video objects in live conversations. The intended purpose of it is to provide a video object in your webcam configuration and test GUI. The video object returned by CreatePreviewlVideo cannot be used for sending out video streams. In live conversations, use Skype::CreateLocalVideo method instead. 
        
        For list of valid webcams, use Skype::GetAvailableVideoDevices method. Note that Skype::GetAvailableVideoDevices should not be called immediately after successful login. It will take several seconds for the runtime to populate the webcam list and until that happens, the video device lists will return empty. Instead of retrieving the video device list at startup, you should always handle the Skype::OnAvailableVideoDeviceListChange event and use the GetAvailableVideoDevices method to check if the list has now non-zero video devices in it. You should only enable video features in your GUI once this has happened. 
        
        This replaces the now deprecated Skype::GetPreviewVideo method. 
        ...
        """
        l_request = skypekit.XCallRequest("ZR\000\220\001", 0, 144)
        l_request.add_parm('e', 1, Video.MEDIATYPE[type_])
        l_request.add_parm('S', 2, device_name)
        l_request.add_parm('S', 3, device_path)
        l_response = self.transport.xcall(l_request)
    ...
    QUALITYTESTTYPE = {0:'QTT_AUDIO_IN', 'QTT_AUDIO_IN':0, 1:'QTT_AUDIO_OUT', 'QTT_AUDIO_OUT':1, 2:'QTT_VIDEO_OUT', 'QTT_VIDEO_OUT':2, 3:'QTT_CPU', 'QTT_CPU':3, 4:'QTT_NETWORK', 'QTT_NETWORK':4, 5:'QTT_VIDEO_IN', 'QTT_VIDEO_IN':5}
    """
     - QTT_AUDIO_IN
     - QTT_AUDIO_OUT
     - QTT_VIDEO_OUT
     ...
     - QTT_VIDEO_IN
    """
    QUALITYTESTRESULT = {0:'QTR_UNDEFINED', 'QTR_UNDEFINED':0, 1:'QTR_CRITICAL', 'QTR_CRITICAL':1, 2:'QTR_POOR', 'QTR_POOR':2, 3:'QTR_AVERAGE', 'QTR_AVERAGE':3, 4:'QTR_GOOD', 'QTR_GOOD':4, 5:'QTR_EXCELLENT', 'QTR_EXCELLENT':5}
    """
     - QTR_UNDEFINED
     - QTR_CRITICAL
     - QTR_POOR
    ...
    def StartMonitoringQuality(
        ...
        B{Arguments:}
         - B{with_user} - if empty, network test results would reflect status of local node only
         - B{exclude_network_test}
        """
        l_request = skypekit.XCallRequest("ZR\000\214\001", 0, 140)
        l_request.add_parm('S', 1, with_user)
        l_request.add_parm('b', 2, exclude_network_test)
        self.transport.xcall(l_request)
    def StopMonitoringQuality(
        self,
        with_user,
        just_stop = False
        ):
        ...
        B{Return values:}
         - B{result}
        """
        l_request = skypekit.XCallRequest("ZR\000\215\001", 0, 141)
        l_request.add_parm('S', 1, with_user)
        l_request.add_parm('b', 2, just_stop)
        l_response = self.transport.xcall(l_request)
        l_result = skypekit.enumof(Skype.QUALITYTESTRESULT, l_response.get(1))
        return l_result
    def OnQualityTestResult(
        self,
        test_type,
        test_result,
        with_user,
        ...
        """
        pass
    event_handlers[28] = "_sk_on_quality_test_result"
    def _sk_on_quality_test_result(self, parms):
        """ internal event dispatcher for OnQualityTestResult  """
        l_cleanparms = (Skype.QUALITYTESTTYPE[parms.get(0)]),
        l_cleanparms += (Skype.QUALITYTESTRESULT[parms.get(1)]),
        l_cleanparms += (parms.get(2, '')),
        l_cleanparms += (parms.get(3, '')),
        l_cleanparms += (parms.get(4, '')),
        self.OnQualityTestResult(*l_cleanparms)
    def GetGreeting(
        self,
        skype_name
        ):
    ...
    def RequestConfirmationCode(
        ...
        """
        creates and sends a CONFIRMATION_CODE_REQUEST message 
        this sends a confirmation code to the number provided
    ...
    def SubmitConfirmationCode(
        ...
        """
        creates and sends a CONFIRMATION_CODE_SUBMIT message 
        this authorizes the number with the server for the purpose given in RequestConfirmationCode
    ...
    PARTNER_ID = {0:'PARTNER_NONE', 'PARTNER_NONE':0, 95:'PARTNER_FACEBOOK', 'PARTNER_FACEBOOK':95, 999:'PARTNER_MICROSOFT', 'PARTNER_MICROSOFT':999}
    """
    Partner ID (keep in sync with common-servers/uicattr.hpp)
     - PARTNER_NONE
     - PARTNER_FACEBOOK
     - PARTNER_MICROSOFT
    """
    ...
    def ValidatePassword(
        ...
        l_result = skypekit.enumof(Skype.VALIDATERESULT, l_response.get(1))
        return l_result
    def GetLoginStatsSampling(self):
        """
        login tracking, string for int in range 0 - no tracking ... 100 - full tracking
        
        B{Return values:}
         - B{sampling}
        """
        l_request = skypekit.XCallRequest("ZR\000Y", 0, 89)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, '')
        return l_result
    ...
    def GetISOLanguageInfo(self):
        ...
        B{Return values:}
         ...
         - B{language_name_list} - assumes UI has set correct language (UIPROP_LANGUAGE)
        """
    ...
    def GetISOCountryInfo(self):
        ...
        B{Return values:}
         - B{country_code_list}
         - B{country_name_list} - assumes UI has set correct language (UIPROP_LANGUAGE)
        ...
        return l_result
    def GetSupportedUILanguageList(self):
        """
        Get list of supported UI languages
        
        B{Return values:}
         - B{ui_language_code_list}
        """
        l_request = skypekit.XCallRequest("ZR\000\207\001", 0, 135)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, [])
        return l_result
    ...
    AUTH_RESULT = {
        0:'AUTH_OK',
        1:'AUTH_INTERNAL_ERROR',
        2:'AUTH_MISSING_PARAMETER',
        3:'AUTH_INVALID_PARAMETER',
        4:'AUTH_ANOTHER_MAPPING_EXISTS',
        5:'AUTH_INVALID_SKYPE_AUTHENTICATION',
        6:'AUTH_INVALID_OAUTH_AUTHENTICATION',
        7:'AUTH_USER_IS_UNDERAGE',
        8:'AUTH_PARTNER_INTERNAL_ERROR',
        9:'AUTH_PARTNER_TIMEOUT',
        'AUTH_OK'                                           :0,
    ...
    """
    Result codes for OnAccountPartnerLinkResult()
     - AUTH_OK
     - AUTH_INTERNAL_ERROR
     - AUTH_MISSING_PARAMETER
     - AUTH_INVALID_PARAMETER
     - AUTH_ANOTHER_MAPPING_EXISTS
     - AUTH_INVALID_SKYPE_AUTHENTICATION
     - AUTH_INVALID_OAUTH_AUTHENTICATION
     - AUTH_USER_IS_UNDERAGE
     - AUTH_PARTNER_INTERNAL_ERROR
     - AUTH_PARTNER_TIMEOUT
    """
    def RequestSSOToken(self):
        """
        Request an SSO authentication token
        
        B{Return values:}
         - B{request_id} - Request ID to attach a response to the request (or 0 on error)
        """
        l_request = skypekit.XCallRequest("ZR\000^", 0, 94)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, 0)
        return l_result
    def RequestWebSession(self):
        """
        Request web session cookies
        
        B{Return values:}
         - B{request_id} - Request ID to attach a response to the request (or 0 on error)
        """
        l_request = skypekit.XCallRequest("ZR\000\233\001", 0, 155)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, 0)
        return l_result
    def RequestWebSessionWithPassword(
        self,
        skypename,
        password
        ):
        """
        Request a web session for a user which is not logged in (yet)
        ...
        B{Return values:}
         - B{request_id} - Request ID to attach a response to the request (or 0 on error)
        """
        l_request = skypekit.XCallRequest("ZR\000\234\001", 0, 156)
        l_request.add_parm('S', 1, skypename)
        l_request.add_parm('S', 2, password)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, 0)
        return l_result
    def OnAuthTokenResult(
        self,
        success,
        request_id,
        token
        ...
        """
        An authentication token request (such as SSO) was processed
        ...
        """
        pass
    event_handlers[29] = "_sk_on_auth_token_result"
    def _sk_on_auth_token_result(self, parms):
        """ internal event dispatcher for OnAuthTokenResult  """
        l_cleanparms = (parms.get(1, False)),
        l_cleanparms += (parms.get(2, 0)),
        l_cleanparms += (parms.get(3, '')),
        self.OnAuthTokenResult(*l_cleanparms)
    def OnAuthTokenRequest(
        self,
        partner_id,
        scopes
        ):
        """
        Request an auth token (oAuth access token or a RPS token) from the UI (Windows 8 in paricular)
        ...
        """
        pass
    event_handlers[36] = "_sk_on_auth_token_request"
    def _sk_on_auth_token_request(self, parms):
        """ internal event dispatcher for OnAuthTokenRequest  """
        l_cleanparms = (parms.get(1, 0L)),
        l_cleanparms += (parms.get(2, [])),
        self.OnAuthTokenRequest(*l_cleanparms)
    def PutAuthTokens(
        self,
        partner_id,
        scopes,
        ...
        """
        Store auth tokens (oAuth access/request tokens or RPS tokens + TGT tickets) gathered by the UI to CoreLib - should be called as a reaction to OnAuthTokenRequest
        
        B{Arguments:}
         - B{partner_id} - Partner ID
         - B{scopes} - List of oAuth scopes for the access token
         - B{access_token} - The oAuth access token
         - B{expiration_time} - Expiration time for accessToken (optional)
         - B{refresh_token} - The oAuth refresh token (optional)
        
        B{Return values:}
         - B{success}
        """
        l_request = skypekit.XCallRequest("ZR\000\235\001", 0, 157)
        l_request.add_parm('U', 1, partner_id)
        l_request.add_parm('S', 2, scopes)
        l_request.add_parm('S', 3, access_token)
        l_request.add_parm('u', 4, expiration_time)
        l_request.add_parm('S', 5, refresh_token)
        l_response = self.transport.xcall(l_request)
        l_result = l_response.get(1, False)
        return l_result
    def LinkAccountWithPartner(
        self,
        partner_id,
        access_token,
        skypename,
        ...
        """
        Link the Skype account (identified by skypename + password) with a partner account using oAuth accessToken
        
        B{Arguments:}
         - B{partner_id} - Partner ID
         - B{access_token} - oAuth access token of the partner account
         - B{skypename} - Skype username - can be empty, a technical user will be created in that case
         - B{password} - Skype password
         - B{reason} - Optional reason code for the linking (an arbitrary string)
         - B{allow_spam} - Allow sending promotions and other material
         - B{allow_sms} - Allow sending SMSs
        """
        l_request = skypekit.XCallRequest("ZR\000\236\001", 0, 158)
        l_request.add_parm('U', 1, partner_id)
        l_request.add_parm('S', 2, access_token)
        l_request.add_parm('S', 3, skypename)
        l_request.add_parm('S', 4, password)
        l_request.add_parm('S', 5, reason)
        l_request.add_parm('b', 6, allow_spam)
        l_request.add_parm('b', 7, allow_sms)
        self.transport.xcall(l_request)
    def OnAccountPartnerLinkResult(
        self,
        code,
        body
        ):
        """
        Passes the (asynchronous) result of LinkAccountWithPartner() back to the caller
        
        B{Return values:}
         - B{code} - result code - see the AUTH_RESULT definition
         - B{body} - contains the techical user skypename if it was created - otherwise contains the HTTP result body (may indicate errors)
        """
        pass
    event_handlers[38] = "_sk_on_account_partner_link_result"
    def _sk_on_account_partner_link_result(self, parms):
        """ internal event dispatcher for OnAccountPartnerLinkResult  """
        l_cleanparms = (Skype.AUTH_RESULT[parms.get(1)]),
        l_cleanparms += (parms.get(2, '')),
        self.OnAccountPartnerLinkResult(*l_cleanparms)

def GetSkype(apptoken, has_event_thread=True, host='127.0.0.1', port=8963, logtransport=False, secure=True):
    setup = "SkypeKit/SubscribedProperties=10:155,10:154,10:151,10:152,10:153,2:202,2:4,2:6,2:5,2:7,2:8,2:9,2:10,2:11,2:12,2:13,2:14,2:15,2:16,2:17,2:18,2:37,2:26,2:205,2:27,2:36,2:19,2:28,2:29,2:182,2:183,2:20,2:25,2:35,2:34,2:21,2:22,2:23,2:33,2:180,2:39,2:41,2:184,2:185,2:186,2:187,2:188,2:189,2:42,1:200,19:930,19:931,19:932,19:933,19:934,19:935,19:936,19:943,19:938,19:948,19:939,19:941,19:942,19:947,19:949,19:950,19:951,19:952,19:953,19:954,19:955,18:972,18:902,18:918,18:974,18:996,18:920,18:921,18:925,18:924,18:927,18:928,18:973,18:975,18:976,18:977,18:970,18:971,18:979,18:981,18:915,18:903,18:904,18:919,18:922,18:906,18:907,18:909,18:980,18:910,18:911,18:913,18:914,9:960,9:120,9:122,9:123,9:792,9:790,9:121,9:961,9:962,9:968,9:222,9:223,9:963,9:964,9:127,9:125,9:966,9:126,9:982,11:130,11:131,11:132,11:133,11:134,11:1104,11:1105,7:100,7:101,7:102,7:103,7:104,7:105,7:106,7:107,7:108,7:109,7:830,7:831,12:190,12:1211,12:191,12:192,12:48,12:198,12:193,12:49,12:194,12:199,12:195,12:196,12:197,12:840,6:80,6:81,6:82,6:83,6:84,6:85,6:86,6:87,6:88,6:89,6:90,6:91,6:92,6:93,6:98,5:70,5:71,5:73,5:78,5:72,5:74,5:75,5:804,5:76,5:79,5:77,5:160,5:161,5:162,5:163,5:164,5:165,5:166,5:168,5:169,5:773,5:800,5:801,5:802,5:4,5:5,5:7,5:8,5:9,5:10,5:11,5:12,5:13,5:14,5:15,5:16,5:17,5:18,5:19,5:26,5:27,5:28,5:34,5:37,5:182,5:183,5:205\nSkypeKit/SubscribedEvents=10:1,10:2,0:1,0:2,0:3,1:1,19:1,19:146,18:1,18:2,18:3,0:4,0:5,0:7,0:44,0:28,0:10,0:11,0:12,0:6,0:8,0:29,0:36,0:38\n"
